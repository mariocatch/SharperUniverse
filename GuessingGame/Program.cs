...
namespace GuessingGame
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var builder = new GameRunnerBuilder()
                .AddIOHandler<ConsoleIOHandler>()
                .AddSystem<PlayerSystem, PlayerComponent>(NumPlayers)
                .AddSystem<RoundSystem, RoundComponent>()
    ...
    public class GuessCommandBinding : IUniverseCommandBinding
    {
        ...
        public GuessCommandBinding(string commandName, IIOHandler ioHandler, RoundSystem roundSystem, PlayerSystem playerSystem)
        {
